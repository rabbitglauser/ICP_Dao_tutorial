...
import { idlFactory } from './basic_dao.did.js';
export { idlFactory } from './basic_dao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BASIC_DAO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./basic_dao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the basic_dao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./basic_dao.did.js")._SERVICE>}
 */
export const basic_dao = createActor(canisterId);
